        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-categories-box">
                    <img src="{{asset('assets/site/img/categories/img1.jpg')}}" alt="image">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-categories-box">
                    <img src="{{asset('assets/site/img/categories/img2.jpg')}}" alt="image">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-categories-box">
                    <img src="{{asset('assets/site/img/categories/img3.jpg')}}" alt="image">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-categories-box">
                    <img src="{{asset('assets/site/img/categories/img4.jpg')}}" alt="image">
        ...
        <div class="row">
                ...
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img1.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover1.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img2.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover2.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img3.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover3.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img4.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover4.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img5.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover5.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img6.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover6.jpg')}}" class="hover-image" alt="image">
                        </a>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img7.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover7.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img8.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover8.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img9.jp')}}g" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover9.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img10.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover10.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img11.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover11.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img12.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover12.jpg')}}" class="hover-image" alt="image">
                        </a>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img13.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover13.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img14.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover14.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img15.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover15.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img16.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover16.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img17.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover17.jpg')}}" class="hover-image" alt="image">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="products-image">
                        <a href="products-type-1.html">
                            <img src="{{asset('assets/site/img/products/img18.jpg')}}" class="main-image" alt="image">
                            <img src="{{asset('assets/site/img/products/img-hover18.jpg')}}" class="hover-image" alt="image">
                        </a>
    ...
    <div class="container">
        ...
        <div class="partner-slides owl-carousel owl-theme">
            <div class="partner-item">
                <a href="#"><img src="{{asset('assets/site/img/partner/partner1.png')}}" alt="image"></a>
            </div>

            <div class="partner-item">
                <a href="#"><img src="{{asset('assets/site/img/partner/partner2.png')}}" alt="image"></a>
            </div>

            <div class="partner-item">
                <a href="#"><img src="{{asset('assets/site/img/partner/partner3.png')}}" alt="image"></a>
            </div>

            <div class="partner-item">
                <a href="#"><img src="{{asset('assets/site/img/partner/partner4.png')}}" alt="image"></a>
            </div>

            <div class="partner-item">
                <a href="#"><img src="{{asset('assets/site/img/partner/partner5.png')}}" alt="image"></a>
            </div>

            <div class="partner-item">
                <a href="#"><img src="{{asset('assets/site/img/partner/partner6.png')}}" alt="image"></a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
                ...
                <div class="single-blog-post">
                    <div class="post-image">
                        <a href="single-blog-1.html">
                            <img src="{{asset('assets/site/img/blog/img1.jpg')}}" alt="image">
                        </a>
                        <div class="date">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    <div class="post-image">
                        <a href="single-blog-1.html">
                            <img src="{{asset('assets/site/img/blog/img2.jpg')}}" alt="image">
                        </a>
                        <div class="date">
                            <span>January 29, 2021</span>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    <div class="post-image">
                        <a href="single-blog-1.html">
                            <img src="{{asset('assets/site/img/blog/img3.jpg')}}" alt="image">
                        </a>
                        <div class="date">
                            <span>January 29, 2021</span>
                        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="instagram-slides owl-carousel owl-theme">
            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img1.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>

            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img2.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>

            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img3.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>

            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img4.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>

            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img10.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>

            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img6.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>

            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img7.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>

            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img8.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>

            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img9.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>

            <div class="single-instagram-post">
                <img src="{{asset('assets/site/img/instagram/img5.jpg')}}" alt="image">
                <i class='bx bxl-instagram'></i>
                <a href="#" target="_blank" class="link-btn"></a>
            </div>
        </div>
            ...
            <div class="modal-body">
                ...
                <div class="sidebar-new-in-store">
                    ...
                    <ul class="products-list">
                        <li>
                            <a href="#"><img src="{{asset('assets/site/img/products/img1.jpg')}}" alt="image"></a>
                        </li>

                        <li>
                            <a href="#"><img src="{{asset('assets/site/img/products/img2.jpg')}}" alt="image"></a>
                        </li>

                        <li>
                            <a href="#"><img src="{{asset('assets/site/img/products/img3.jpg')}}" alt="image"></a>
                        </li>

                        <li>
                            <a href="#"><img src="{{asset('assets/site/img/products/img4.jpg')}}" alt="image"></a>
                        </li>
                    </ul>
        ...
        <div class="modal-content">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="products-image">
                        <img src="{{asset('assets/site/img/quick-view-img.jpg')}}" alt="image">
                    </div>
                </div>
                ...
                <div class="woocommerce-widget-area">
                    ...
                    <div class="woocommerce-widget aside-trending-widget">
                        <div class="aside-trending-products">
                            <img src="{{asset('assets/site/img/offer-bg.jpg')}}" alt="image">

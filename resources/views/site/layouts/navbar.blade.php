    ...
    <div class="xton-responsive-nav">
        <div class="container">
            <div class="xton-responsive-menu">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{asset('assets/site/img/logo.png')}}" class="main-logo" alt="logo">
                        <img src="{{asset('assets/site/img/white-logo.png')}}" class="white-logo" alt="logo">
                    </a>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="brand-slides owl-carousel owl-theme">
                                            <div class="brand-item">
                                                <a href="#"><img src="{{asset('assets/site/img/brand/img1.png')}}" alt="image"></a>
                                            </div>

                                            <div class="brand-item">
                                                <a href="#"><img src="{{asset('assets/site/img/brand/img2.png')}}" alt="image"></a>
                                            </div>

                                            <div class="brand-item">
                                                <a href="#"><img src="{{asset('assets/site/img/brand/img3.png')}}" alt="image"></a>
                                            </div>

                                            <div class="brand-item">
                                                <a href="#"><img src="{{asset('assets/site/img/brand/img4.png')}}" alt="image"></a>
                                            </div>

                                            <div class="brand-item">
                                                <a href="#"><img src="{{asset('assets/site/img/brand/img5.png')}}" alt="image"></a>
                                            </div>

                                            <div class="brand-item">
                                                <a href="#"><img src="{{asset('assets/site/img/brand/img6.png')}}" alt="image"></a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
